...
Here, I create histograms and QQ-plots for the size distribution for each of the treatments (Annual and Control) to look at and consider to assess normality. 
...
The distribution of urchin sizes for the Control and Annual groups appear to be normally distributed, with somewhat bell-shaped histograms and linear QQ-plots. For the Annual group, there may be some positive skew which is reflected in the histogram and QQ-plot. Note that any concerns we may have with the histogram and QQ-plot may be assuaged, given that the sample sizes are greater than 30 and the Central Limit Theorem says that the distribution of means is going to be normal even if our population distribution were not normally distributed. 
